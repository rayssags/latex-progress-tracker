...
wc_color=plt.rcParams['axes.prop_cycle'].by_key()['color'][0]
pc_color=plt.rcParams['axes.prop_cycle'].by_key()['color'][1]
...
ax.set_ylim(ymin=42)
ax2.set_ylim(ymin=42)

plt.annotate("{:0.0f} Pages".format(current_pagecount), xy=(.05,.88), xycoords="axes fraction",color=pc_color, fontsize=14)
plt.annotate("{:0.0f} Words".format(current_wordcount), xy=(.05,.8), xycoords="axes fraction",color=wc_color, fontsize=14)
...
dates = {}
dates["Voltei a frequentar o OV\n"] = "2022-04-14 15:30:00"
